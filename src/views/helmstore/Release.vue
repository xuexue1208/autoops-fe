            ...
            <a-table
                ...
                <template #bodyCell="{ column, record }">
                    ...
                    <template v-if="column.key === 'action'">
                        <c-button style="margin-bottom:5px;" class="release-button" type="cyan" icon="form-outlined" @click="getReleaseDetail(record)">Manifest</c-button>
                        <c-button class="release-button" type="warning" icon="delete-outlined" @click="showConfirm('卸载', record.name, delRelease)">卸载</c-button>
                    </template>
                </template>
            </a-table>
        </a-card>
