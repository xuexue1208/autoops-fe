            ...
            <a-table
                ...
                <template #bodyCell="{ column, record }">
                    ...
                    <template v-if="column.key === 'action'">
                        <c-button style="margin-bottom:5px;" class="namespace-button" type="cyan" icon="form-outlined" @click="getNamespaceDetail(record)">YML</c-button>
                        <c-button class="namespace-button" type="warning" icon="delete-outlined" @click="showConfirm('删除', record.metadata.name, delNamespace)">删除</c-button>
                    </template>
                </template>
            </a-table>
        </a-card>
