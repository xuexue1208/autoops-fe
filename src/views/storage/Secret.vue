            ...
            <a-table
                ...
                <template #bodyCell="{ column, record }">
                    ...
                    <template v-if="column.key === 'action'">
                        <c-button style="margin-bottom:5px;" class="secret-button" type="cyan" icon="form-outlined" @click="getSecretDetail(record)">YML</c-button>
                        <c-button class="secret-button" type="warning" icon="delete-outlined" @click="showConfirm('删除', record.metadata.name, delSecret)">删除</c-button>
                    </template>
                </template>
            </a-table>
        </a-card>
